...
<body>	
	...
	<form id="form" class="ftco-section" action="./myDetailAction.jsp" method="post">
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-7 col-lg-5">
					<div class="login-wrap p-4 p-md-5">
						...
						<div class="form-group">
							<input type="submit" class="form-control btn btn-primary rounded button px-3" value="돌아가기" onclick="location.href='../pagemain/mainpage.jsp'">
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	$("#deleteBtn").on("click",function(){
		if(confirm("정말 삭제하세겠습니까?")) {
			form.attr("action","./myDetailAction.jsp?type=delete")
			form.submit();
			alert("삭제되었습니다.");
		} else {
			return;
	...
	$("#updateBtn").on("click",function(){
		alert("수정되었습니다.");
		form.attr("action","./myDetailAction.jsp?type=update");
		form.submit();
	})
