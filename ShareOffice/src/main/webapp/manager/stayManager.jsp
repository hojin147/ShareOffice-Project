...
import="office.Reservation" import="java.util.*"%>
				...
				<div style="text-align: center;" class="fresh-table full-color-orange">
					<table style="zoom: 1.5;" id="fresh-table" class="table">
						<thead>
							...
							<th data-field="name" data-sortable="true">예약자</th>
							<th data-field="salary" data-sortable="true">인실</th>
							<th data-field="country" data-sortable="true">지점</th>
							<th>상세보기</th>
						</thead>
						<tbody>
							<%
								ArrayList<Reservation> reservationArr = reservationDAO.selectOccupiedOffice();
							%>
							<c:forEach var="reservation" items="<%=reservationArr%>"
								...
								<tr>
									...
									<td><a style="zoom: 0.9;"
										href="./stayDetail.jsp?num=${reservation.getRvNum()}"
