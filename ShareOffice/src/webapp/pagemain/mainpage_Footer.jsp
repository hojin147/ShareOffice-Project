<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	<footer style="font-size:16px; font-weight: 500;"><hr><br>
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-4 text-lg-start">
					상호명 : 주식회사 OOO<br>
					대표 : OOO | 사업자등록번호 : OOO-OO-OOOOO<br>
					대표전화 : 051-OOO-OOOO<br>
					Copyright © Your Website 2021<br>
				</div>
				<div class="col-lg-4 my-3 my-lg-0" align="center"]>
					<a class="btn btn-dark btn-social mx-2" href="#!">
						<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"
						data-prefix="fas" data-icon="phone-alt"
						class="svg-inline--fa fa-phone-alt fa-w-16" role="img" viewBox="0 0 512 512">
				...
				<div class="col-lg-4 text-lg-end">
					<span>상담시간</span> : 월 ~ 금요일 09:30 ~ 18:00<br>
					<span>점심시간</span> : 12:00 ~ 13:00<br>
					<a class="link-dark text-decoration-none me-2" href="#!">Privacy Policy | Terms of Use</a><br>
					이용약관 | 개인정보처리방침 | 운영정책
				</div>
			</div>
		</div><br><br>
